 ...
 * 09/25/2019
 *
 * This is a quiz for using GitHub and TravisCI
 * Original file is a Split or Steal Game
 *
 * Created by Kevin Buffardi
 * Edited with permission by Michael Harris
 *
 */
...
int main()
{
  ...
  while(cont) {
    ...
    decision1 = std::tolower(decision1);
    ...
    decision2 = std::tolower(decision2);
    ...
    cout<<"Play Again? (Y)es; All other input ends the game."<<endl;

    char contChoice;
    cin >> contChoice;
    contChoice = std::tolower(contChoice);
    if(contChoice != 'y') cont = false;
  }
